    ...
    <div className="min-h-[70vh] flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-16 bg-[#FFF8F1]">
      <div className="text-center max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link href="/career-roadmaps" className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-3.5 bg-white text-[#4F4639] font-medium rounded-xl hover:bg-[#FBF3EB] border border-[#D1C5B4] focus:ring-4 focus:ring-[#D1C5B4]/50 transition-all shadow-sm">
            <Search size={20} className="text-gray-500" />Explore Roadmaps
          </Link>
        </div>
