...
const courseCategories: CourseCategory[] = [
  {
    ...
    items: [
      ...
      { id: 'introduction-bookkeeping-accounting', customContent: 'Accurate data entry is the lifeblood of accounting. This highly practical course focuses on the day-to-day realities of bookkeeping. You will master the rules of debits and credits, learn how to maintain accurate general ledgers, and understand the critical process of bank reconciliation, which covers the exact tasks required for the vast majority of entry-level finance jobs.' }
    ]
  },
  {
