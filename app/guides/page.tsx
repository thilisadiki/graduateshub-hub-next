...
const GUIDE_GROUPS: GuideGroup[] = [
  {
    ...
    guides: [
      ...
      },
      {
        ...
        desc: 'AZ-900 cloud computing, Azure VMs, Blob Storage, Virtual Networks, and free sandbox labs.',
        curators: ['jason'],
      },
      {
        ...
        desc: 'PL-300 Power Query ETL, STAR schema modeling, DAX measures, and RLS dashboard publishing.',
        curators: ['jason'],
      },
      {
        ...
        desc: 'AI-900 Generative AI, Azure OpenAI Service, Microsoft Copilot Studio, and Responsible AI.',
        curators: ['jason'],
      },
      {
        ...
        desc: 'MS-900 Entra ID user provisioning, Exchange Online, SharePoint permissions, and MFA.',
        curators: ['jason'],
      },
    ],
  },
