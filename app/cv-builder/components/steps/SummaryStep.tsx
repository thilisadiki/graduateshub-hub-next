  ...
  return (
    <div className="space-y-3">
      <div>
        ...
        <textarea
          className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-900 bg-gray-50 focus:outline-none focus:bg-white focus:ring-2 focus:ring-primary focus:border-transparent transition resize-none"
          rows={7}
      ...
      <div className="bg-[#FFDF9C]/20 border border-[#D1C5B4] rounded-lg p-3">
        <p className="text-xs font-semibold text-[#5a4000] mb-1">Tips for a strong summary</p>
