...
export default function WhatsAppCard() {
  ...
  useEffect(() => {
    ...
    setHref(`https://wa.me/${number}`);
    // Format as 069 805 3992 for display
    setDisplay(`0${PARTS[1]} ${PARTS[2]} ${PARTS[3]}`);
  }, []);
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
      ...
      <p className="text-sm text-gray-600 mb-3">
        Quick questions? Message us on WhatsApp. We respond during South African business hours.
      </p>
      {href ? (
        <a
          href={href}
