...
const relatedGuides: RelatedGuide[] = [
  ...
  { title: 'Best Free Courses for Data Analysts (2026)', desc: 'Excel, SQL, Python, and Power BI, the complete data analyst learning path, all free.', href: '/free-courses-for-data-analysts' },
