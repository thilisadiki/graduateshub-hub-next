...
export const webDeveloperPrep: InterviewPrep = {
  ...
  salaryBenchmarks: [
    ...
    { region: 'United Kingdom', range: '£25,000 – £40,000/year' },
  ...
  cvTips: [
    {
      ...
      body: 'For developer roles, a GitHub profile often carries more weight than a formal CV. A hiring manager may spend 30 seconds on your CV and five minutes on your GitHub. Ensure your pinned repositories are your best and most recent work, each with a clear README explaining what the project does and how to run it.',
    },
    {
    ...
    },
    {
      ...
      body: 'Development teams vary widely by region and company maturity: some rely on PHP/MySQL or .NET for long-running systems, while newer products may use Node.js, Python, or modern JavaScript frameworks. Knowing which stack a company uses before you apply and tailoring your CV to mention that stack is a significant advantage. Check the job posting and their public-facing website source code if possible.',
    },
    {
  ...
  questions: [
    {
      ...
      why: 'A foundational web development concept tested in many junior developer interviews.',
    ...
    },
    {
      ...
      why: 'Performance troubleshooting is a real-world skill. Many products serve users on slower mobile connections, making this especially relevant.',
    ...
    },
    {
      ...
      why: 'PHP is still widely used in agencies, content-heavy websites, and legacy systems. Authentication handling is a common junior task.',
    ...
    },
    {
      ...
      why: 'Employers want developers with structure and discipline, not just people who start coding immediately.',
