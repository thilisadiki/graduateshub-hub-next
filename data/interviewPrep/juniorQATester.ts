...
export const juniorQATesterPrep: InterviewPrep = {
  ...
  cvMustInclude: [
    ...
    'Any ISTQB Foundation Level certification - it is a widely recognised global QA standard',
  ...
  cvAvoid: [
    ...
    'Omitting manual testing skills. Many teams still rely on manual testing and dismissing it signals naivety about the actual role',
  ...
  cvTips: [
    ...
    },
    {
      ...
      body: 'The ISTQB Foundation Level certification is one of the most recognised QA credentials globally. Costs vary by country, but study materials are widely available online. Many technology companies that hire QA professionals will ask whether you have it or plan to pursue it. Completing it before your job search gives you a significant advantage and demonstrates commitment to the QA profession rather than treating it as a stepping stone to development.',
    },
  ],
  ...
  questions: [
    {
      ...
      why: 'This is a classic ISTQB Foundation question and is asked in many junior QA interviews. It tests whether you understand the QA discipline\'s foundational concepts.',
    ...
    },
    {
      ...
      why: 'Test case design is the core skill of a manual QA tester. This question is used in many QA interviews at entry level to assess structured test thinking.',
    ...
    },
    {
      ...
      why: 'QA managers use this question to assess investigative instincts and genuine curiosity. Entry-level candidates who have never actively sought out bugs give themselves away immediately.',
