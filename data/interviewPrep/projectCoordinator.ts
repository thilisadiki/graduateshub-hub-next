...
export const projectCoordinatorPrep: InterviewPrep = {
  ...
  salaryBenchmarks: [
    ...
    { region: 'Australia', range: 'A$65,000 – A$85,000/year' },
    { region: 'South Africa', range: 'R180,000 – R320,000/year' },
  ],

  cvMustInclude: [
    'Any project management certification or study progress: PMP, CAPM, PRINCE2 Foundation, or Google Project Management Certificate',
  ...
  cvAvoid: [
    ...
    'Claiming PMP certification without having it. Hiring managers verify certifications and the PMP requires documented experience to qualify',
    'Listing project tools you cannot demonstrate proficiency with - a practical test or case study may be part of the process',
    'Omitting the outcomes of projects you managed. "Coordinated a student event" is weaker than "Coordinated a 200-person faculty orientation event, on time and within a $800 budget"',
  ...
  questions: [
    {
      ...
      why: 'This is a common project management screening question in corporate interviews. It tests whether you know the PMBOK framework that many large organisations use.',
    ...
    },
    {
      ...
      why: 'This is a foundational distinction that entry-level project candidates often confuse. Getting it right signals genuine project management training.',
      sampleAnswer: 'A risk is a potential event that has not yet happened - it may or may not occur in the future. An issue is a problem that has already occurred and is currently affecting the project. In practice, a good project coordinator maintains a risk register that tracks identified risks, their probability, impact, mitigation strategy, and owner. When a risk materialises, it moves to the issue log and becomes something that needs immediate management action, not just monitoring. In corporate environments, especially banking, IT, and regulated industries, the distinction matters for reporting - executives want to see risks separated from active issues.',
    },
    {
      question: 'How would you handle a stakeholder who consistently misses project milestones without communicating?',
      why: 'Stakeholder management is one of the hardest practical skills in project coordination. Interviewers use this question to test whether you understand escalation, documentation, and relationship management.',
    ...
    },
    {
      ...
      why: 'The triple constraint is foundational theory that project coordinators are expected to understand from day one. It frames almost every project trade-off conversation.',
