...
export const juniorGraphicDesignerPrep: InterviewPrep = {
  ...
  salaryBenchmarks: [
    ...
    { region: 'Australia', range: 'A$55,000 – A$70,000/year' },
    { region: 'South Africa', range: 'R120,000 – R210,000/year' },
  ],
  ...
  cvAvoid: [
    ...
    'A portfolio that is not mobile-accessible. Recruiters often open links on their phones and a PDF-only portfolio is a barrier',
  ...
  questions: [
    {
      ...
      why: 'This is a common opening question in design interviews. It tests whether you can articulate your process or whether you just produce output without intention.',
    ...
    },
    {
      ...
      why: 'A fundamental production knowledge check. Getting this wrong at entry level is a significant red flag for studios that produce print work.',
    ...
    },
    {
      ...
      why: 'Design studios deal with strong-willed clients and internal hierarchies. Interviewers test whether you can take direction professionally without being a pushover or a yes-person.',
    ...
    },
    {
      ...
      why: 'Creative directors want to know that entry-level designers are engaged with the industry and have opinions, not just technical skills.',
    ...
    },
    {
      ...
      why: 'Studio environments often require designers to handle three to five projects simultaneously. Poor time management is one of the most common complaints creative directors have about junior designers.',
