...
export const digitalMarketingSpecialistRoadmap: CareerRoadmap = {
  ...
  tagline: 'Build campaigns that drive traffic, leads, and revenue — fully remotely.',
  category: 'marketing',
  curator: 'jason',
  ...
  stages: [
    {
      ...
      duration: '2–3 weeks',
      description:
        'Before specialising, you need a clear map of the whole field. Digital marketing encompasses search, social, content, email, paid media, and analytics — and a specialist who only knows one channel is far less valuable than one who understands how they work together. This stage gives you the strategic overview and foundational vocabulary you will use in every subsequent stage.',
    ...
    {
      number: 2,
      title: 'Master the Core Channels — Search & Content',
      duration: '6–8 weeks',
      description:
