...
export default function Hero() {
  return (
    <section
      className="relative pt-8 sm:pt-12 pb-20 sm:pb-24 overflow-hidden border-b border-[#D1C5B4]"
      style={{
        background: [
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-8 min-h-[480px] mb-12 lg:mb-20">
          {/* Left: Text */}
          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left pt-4 lg:pt-0">
            {/* Top Pill Badge */}
            ...
            <div className="flex flex-col sm:flex-row gap-3.5 w-full sm:w-auto">
              <Link
                ...
                className="w-full sm:w-auto inline-flex justify-center items-center gap-2 bg-primary text-white font-extrabold px-8 py-4 rounded-xl hover:bg-[#5a4000] hover:-translate-y-0.5 transition-all shadow-[0_4px_14px_0_rgba(122,89,0,0.35)] hover:shadow-[0_6px_20px_rgba(122,89,0,0.25)] text-base"
              >
            ...
            >
              <span className="flex items-center justify-center w-7 h-7 rounded-full bg-primary text-white shrink-0 shadow-sm">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
                </svg>
              </span>
              <span>
                <strong className="text-[#1F1B13] group-hover:text-primary transition-colors">189K+ followers</strong> on Facebook
              </span>
            </a>
          </div>
          ...
          <div className="w-full lg:w-1/2 relative lg:h-[500px] flex items-center justify-center">
            <div className="relative w-full max-w-md">
              ...
              <div className="relative bg-white border border-[#D1C5B4] shadow-xl rounded-3xl p-6 sm:p-8 overflow-hidden transform transition-all hover:scale-[1.01] duration-500">
              ...
              {/* Floating badge */}
              <div
                className="absolute -left-6 top-12 bg-white p-3 rounded-2xl shadow-xl border border-[#D1C5B4] hidden md:flex items-center gap-3 pr-5 animate-bounce"
                style={{ animationDuration: '3s' }}
              >
                <div className="bg-[#CCECC8] text-[#4B6649] p-2 rounded-xl">
                  <Award size={20} />
                </div>
