    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all border border-gray-100 group">
      ...
      <div className="p-6">
        ...
        {course.isExternal ? (
          ...
          <Link href={`/course/${course.id}`} className="mt-6 block w-full text-center border-2 border-primary text-primary py-2.5 rounded-lg font-bold hover:bg-blue-50 transition-colors">
            View Course Details →
          </Link>
        )}
      </div>
