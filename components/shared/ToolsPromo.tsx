...
export default function ToolsPromo() {
  return (
    <div className="bg-gradient-to-br bg-[#1F1B13] rounded-2xl p-7 md:p-9 flex flex-col md:flex-row items-start md:items-center gap-6 overflow-hidden relative">
      ...
      <div className="relative z-10 flex-1 min-w-0">
        <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#7A5900]/20 border border-[#FFDF9C]/30 text-[#FFDF9C] font-bold text-xs uppercase tracking-wider mb-3">
